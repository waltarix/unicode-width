...
pub mod charwidth {
    ...
    const charwidth_table: &'static [(char, char, u8, u8)] = &[
        ('\u{a1}', '\u{a1}', 2, 2), ('\u{a4}', '\u{a4}', 2, 2), ('\u{a7}', '\u{a8}', 2, 2),
        ('\u{aa}', '\u{aa}', 2, 2), ('\u{ae}', '\u{ae}', 2, 2), ('\u{b0}', '\u{b4}', 2, 2),
        ('\u{b6}', '\u{ba}', 2, 2), ('\u{bc}', '\u{bf}', 2, 2), ('\u{c6}', '\u{c6}', 2, 2),
        ('\u{d0}', '\u{d0}', 2, 2), ('\u{d7}', '\u{d8}', 2, 2), ('\u{de}', '\u{e1}', 2, 2),
        ('\u{e6}', '\u{e6}', 2, 2), ('\u{e8}', '\u{ea}', 2, 2), ('\u{ec}', '\u{ed}', 2, 2),
        ('\u{f0}', '\u{f0}', 2, 2), ('\u{f2}', '\u{f3}', 2, 2), ('\u{f7}', '\u{fa}', 2, 2),
        ('\u{fc}', '\u{fc}', 2, 2), ('\u{fe}', '\u{fe}', 2, 2), ('\u{101}', '\u{101}', 2, 2),
        ('\u{111}', '\u{111}', 2, 2), ('\u{113}', '\u{113}', 2, 2), ('\u{11b}', '\u{11b}', 2, 2),
        ('\u{126}', '\u{127}', 2, 2), ('\u{12b}', '\u{12b}', 2, 2), ('\u{131}', '\u{133}', 2, 2),
        ('\u{138}', '\u{138}', 2, 2), ('\u{13f}', '\u{142}', 2, 2), ('\u{144}', '\u{144}', 2, 2),
        ('\u{148}', '\u{14b}', 2, 2), ('\u{14d}', '\u{14d}', 2, 2), ('\u{152}', '\u{153}', 2, 2),
        ('\u{166}', '\u{167}', 2, 2), ('\u{16b}', '\u{16b}', 2, 2), ('\u{1ce}', '\u{1ce}', 2, 2),
        ('\u{1d0}', '\u{1d0}', 2, 2), ('\u{1d2}', '\u{1d2}', 2, 2), ('\u{1d4}', '\u{1d4}', 2, 2),
        ('\u{1d6}', '\u{1d6}', 2, 2), ('\u{1d8}', '\u{1d8}', 2, 2), ('\u{1da}', '\u{1da}', 2, 2),
        ('\u{1dc}', '\u{1dc}', 2, 2), ('\u{251}', '\u{251}', 2, 2), ('\u{261}', '\u{261}', 2, 2),
        ('\u{2c4}', '\u{2c4}', 2, 2), ('\u{2c7}', '\u{2c7}', 2, 2), ('\u{2c9}', '\u{2cb}', 2, 2),
        ('\u{2cd}', '\u{2cd}', 2, 2), ('\u{2d0}', '\u{2d0}', 2, 2), ('\u{2d8}', '\u{2db}', 2, 2),
        ('\u{2dd}', '\u{2dd}', 2, 2), ('\u{2df}', '\u{2df}', 2, 2), ('\u{300}', '\u{36f}', 0, 0),
        ('\u{391}', '\u{3a1}', 2, 2), ('\u{3a3}', '\u{3a9}', 2, 2), ('\u{3b1}', '\u{3c1}', 2, 2),
        ('\u{3c3}', '\u{3c9}', 2, 2), ('\u{401}', '\u{401}', 2, 2), ('\u{410}', '\u{44f}', 2, 2),
        ('\u{451}', '\u{451}', 2, 2), ('\u{483}', '\u{489}', 0, 0), ('\u{591}', '\u{5bd}', 0, 0),
        ...
        ('\u{2010}', '\u{2010}', 2, 2), ('\u{2013}', '\u{2016}', 2, 2), ('\u{2018}', '\u{2019}', 2,
        2), ('\u{201c}', '\u{201d}', 2, 2), ('\u{2020}', '\u{2022}', 2, 2), ('\u{2024}', '\u{2027}',
        2, 2), ('\u{202a}', '\u{202e}', 0, 0), ('\u{2030}', '\u{2030}', 2, 2), ('\u{2032}',
        '\u{2033}', 2, 2), ('\u{2035}', '\u{2035}', 2, 2), ('\u{203b}', '\u{203b}', 2, 2),
        ('\u{203e}', '\u{203e}', 2, 2), ('\u{2060}', '\u{2064}', 0, 0), ('\u{2066}', '\u{206f}', 0,
        0), ('\u{2074}', '\u{2074}', 2, 2), ('\u{207f}', '\u{207f}', 2, 2), ('\u{2081}', '\u{2084}',
        2, 2), ('\u{20ac}', '\u{20ac}', 2, 2), ('\u{20d0}', '\u{20f0}', 0, 0), ('\u{2103}',
        '\u{2103}', 2, 2), ('\u{2105}', '\u{2105}', 2, 2), ('\u{2109}', '\u{2109}', 2, 2),
        ('\u{2113}', '\u{2113}', 2, 2), ('\u{2116}', '\u{2116}', 2, 2), ('\u{2121}', '\u{2122}', 2,
        2), ('\u{2126}', '\u{2126}', 2, 2), ('\u{212b}', '\u{212b}', 2, 2), ('\u{2153}', '\u{2154}',
        2, 2), ('\u{215b}', '\u{215e}', 2, 2), ('\u{2160}', '\u{216b}', 2, 2), ('\u{2170}',
        '\u{2179}', 2, 2), ('\u{2189}', '\u{2189}', 2, 2), ('\u{2190}', '\u{2199}', 2, 2),
        ('\u{21b8}', '\u{21b9}', 2, 2), ('\u{21d2}', '\u{21d2}', 2, 2), ('\u{21d4}', '\u{21d4}', 2,
        2), ('\u{21e7}', '\u{21e7}', 2, 2), ('\u{2200}', '\u{2200}', 2, 2), ('\u{2202}', '\u{2203}',
        2, 2), ('\u{2207}', '\u{2208}', 2, 2), ('\u{220b}', '\u{220b}', 2, 2), ('\u{220f}',
        '\u{220f}', 2, 2), ('\u{2211}', '\u{2211}', 2, 2), ('\u{2215}', '\u{2215}', 2, 2),
        ('\u{221a}', '\u{221a}', 2, 2), ('\u{221d}', '\u{2220}', 2, 2), ('\u{2223}', '\u{2223}', 2,
        2), ('\u{2225}', '\u{2225}', 2, 2), ('\u{2227}', '\u{222c}', 2, 2), ('\u{222e}', '\u{222e}',
        2, 2), ('\u{2234}', '\u{2237}', 2, 2), ('\u{223c}', '\u{223d}', 2, 2), ('\u{2248}',
        '\u{2248}', 2, 2), ('\u{224c}', '\u{224c}', 2, 2), ('\u{2252}', '\u{2252}', 2, 2),
        ('\u{2260}', '\u{2261}', 2, 2), ('\u{2264}', '\u{2267}', 2, 2), ('\u{226a}', '\u{226b}', 2,
        2), ('\u{226e}', '\u{226f}', 2, 2), ('\u{2282}', '\u{2283}', 2, 2), ('\u{2286}', '\u{2287}',
        2, 2), ('\u{2295}', '\u{2295}', 2, 2), ('\u{2299}', '\u{2299}', 2, 2), ('\u{22a5}',
        '\u{22a5}', 2, 2), ('\u{22bf}', '\u{22bf}', 2, 2), ('\u{2312}', '\u{2312}', 2, 2),
        ('\u{231a}', '\u{231b}', 2, 2), ('\u{2329}', '\u{232a}', 2, 2), ('\u{23e9}', '\u{23ec}', 2,
        2), ('\u{23f0}', '\u{23f0}', 2, 2), ('\u{23f3}', '\u{23f3}', 2, 2), ('\u{2460}', '\u{24e9}',
        2, 2), ('\u{25b2}', '\u{25b3}', 2, 2), ('\u{25b6}', '\u{25b7}', 2, 2), ('\u{25bc}',
        '\u{25bd}', 2, 2), ('\u{25c0}', '\u{25c1}', 2, 2), ('\u{25c6}', '\u{25c8}', 2, 2),
        ('\u{25cb}', '\u{25cb}', 2, 2), ('\u{25ce}', '\u{25d1}', 2, 2), ('\u{25e2}', '\u{25e5}', 2,
        2), ('\u{25ef}', '\u{25ef}', 2, 2), ('\u{25fd}', '\u{25fe}', 2, 2), ('\u{2605}', '\u{2606}',
        2, 2), ('\u{2609}', '\u{2609}', 2, 2), ('\u{260e}', '\u{260f}', 2, 2), ('\u{2614}',
        '\u{2615}', 2, 2), ('\u{261c}', '\u{261c}', 2, 2), ('\u{261e}', '\u{261e}', 2, 2),
        ('\u{2640}', '\u{2640}', 2, 2), ('\u{2642}', '\u{2642}', 2, 2), ('\u{2648}', '\u{2653}', 2,
        2), ('\u{2660}', '\u{2661}', 2, 2), ('\u{2663}', '\u{2665}', 2, 2), ('\u{2667}', '\u{266a}',
        2, 2), ('\u{266c}', '\u{266d}', 2, 2), ('\u{266f}', '\u{266f}', 2, 2), ('\u{267f}',
        '\u{267f}', 2, 2), ('\u{2693}', '\u{2693}', 2, 2), ('\u{269e}', '\u{269f}', 2, 2),
        ('\u{26a1}', '\u{26a1}', 2, 2), ('\u{26aa}', '\u{26ab}', 2, 2), ('\u{26bd}', '\u{26bf}', 2,
        2), ('\u{26c4}', '\u{26e1}', 2, 2), ('\u{26e3}', '\u{26e3}', 2, 2), ('\u{26e8}', '\u{26ff}',
        2, 2), ('\u{2705}', '\u{2705}', 2, 2), ('\u{270a}', '\u{270b}', 2, 2), ('\u{2728}',
        '\u{2728}', 2, 2), ('\u{273d}', '\u{273d}', 2, 2), ('\u{274c}', '\u{274c}', 2, 2),
        ('\u{274e}', '\u{274e}', 2, 2), ('\u{2753}', '\u{2755}', 2, 2), ('\u{2757}', '\u{2757}', 2,
        2), ('\u{2776}', '\u{277f}', 2, 2), ('\u{2795}', '\u{2797}', 2, 2), ('\u{27b0}', '\u{27b0}',
        2, 2), ('\u{27bf}', '\u{27bf}', 2, 2), ('\u{2b1b}', '\u{2b1c}', 2, 2), ('\u{2b50}',
        '\u{2b50}', 2, 2), ('\u{2b55}', '\u{2b59}', 2, 2), ('\u{2cef}', '\u{2cf1}', 0, 0),
        ...
        2), ('\u{3190}', '\u{31e3}', 2, 2), ('\u{31f0}', '\u{321e}', 2, 2), ('\u{3220}', '\u{4dbf}',
        2, 2), ('\u{4e00}', '\u{a48c}', 2, 2), ('\u{a490}', '\u{a4c6}', 2, 2), ('\u{a66f}',
        '\u{a672}', 0, 0), ('\u{a674}', '\u{a67d}', 0, 0), ('\u{a69e}', '\u{a69f}', 0, 0),
        ('\u{a6f0}', '\u{a6f1}', 0, 0), ('\u{a802}', '\u{a802}', 0, 0), ('\u{a806}', '\u{a806}', 0,
        0), ('\u{a80b}', '\u{a80b}', 0, 0), ('\u{a825}', '\u{a826}', 0, 0), ('\u{a82c}', '\u{a82c}',
        0, 0), ('\u{a8c4}', '\u{a8c5}', 0, 0), ('\u{a8e0}', '\u{a8f1}', 0, 0), ('\u{a8ff}',
        '\u{a8ff}', 0, 0), ('\u{a926}', '\u{a92d}', 0, 0), ('\u{a947}', '\u{a951}', 0, 0),
        ('\u{a960}', '\u{a97c}', 2, 2), ('\u{a980}', '\u{a982}', 0, 0), ('\u{a9b3}', '\u{a9b3}', 0,
        0), ('\u{a9b6}', '\u{a9b9}', 0, 0), ('\u{a9bc}', '\u{a9bd}', 0, 0), ('\u{a9e5}', '\u{a9e5}',
        0, 0), ('\u{aa29}', '\u{aa2e}', 0, 0), ('\u{aa31}', '\u{aa32}', 0, 0), ('\u{aa35}',
        '\u{aa36}', 0, 0), ('\u{aa43}', '\u{aa43}', 0, 0), ('\u{aa4c}', '\u{aa4c}', 0, 0),
        ('\u{aa7c}', '\u{aa7c}', 0, 0), ('\u{aab0}', '\u{aab0}', 0, 0), ('\u{aab2}', '\u{aab4}', 0,
        0), ('\u{aab7}', '\u{aab8}', 0, 0), ('\u{aabe}', '\u{aabf}', 0, 0), ('\u{aac1}', '\u{aac1}',
        0, 0), ('\u{aaec}', '\u{aaed}', 0, 0), ('\u{aaf6}', '\u{aaf6}', 0, 0), ('\u{abe5}',
        '\u{abe5}', 0, 0), ('\u{abe8}', '\u{abe8}', 0, 0), ('\u{abed}', '\u{abed}', 0, 0),
        ('\u{ac00}', '\u{d7a3}', 2, 2), ('\u{e000}', '\u{e09f}', 2, 2), ('\u{e0d8}', '\u{faff}', 2,
        2), ('\u{fb1e}', '\u{fb1e}', 0, 0), ('\u{fe00}', '\u{fe0f}', 0, 0), ('\u{fe10}', '\u{fe19}',
        2, 2), ('\u{fe20}', '\u{fe2f}', 0, 0), ('\u{fe30}', '\u{fe52}', 2, 2), ('\u{fe54}',
        '\u{fe66}', 2, 2), ('\u{fe68}', '\u{fe6b}', 2, 2), ('\u{feff}', '\u{feff}', 0, 0),
        ('\u{ff01}', '\u{ff60}', 2, 2), ('\u{ffe0}', '\u{ffe6}', 2, 2), ('\u{fff9}', '\u{fffb}', 0,
        0), ('\u{fffd}', '\u{fffd}', 2, 2), ('\u{101fd}', '\u{101fd}', 0, 0), ('\u{102e0}',
        ...
        '\u{1f10a}', 2, 2), ('\u{1f110}', '\u{1f12d}', 2, 2), ('\u{1f130}', '\u{1f169}', 2, 2),
        ('\u{1f170}', '\u{1f1ac}', 2, 2), ('\u{1f200}', '\u{1f202}', 2, 2), ('\u{1f210}',
        ...
        '\u{1f6d7}', 2, 2), ('\u{1f6eb}', '\u{1f6ec}', 2, 2), ('\u{1f6f4}', '\u{1f6fc}', 2, 2),
        ('\u{1f7e0}', '\u{1f7eb}', 2, 2), ('\u{1f90c}', '\u{1f93a}', 2, 2), ('\u{1f93c}',
        '\u{1f945}', 2, 2), ('\u{1f947}', '\u{1f978}', 2, 2), ('\u{1f97a}', '\u{1f9cb}', 2, 2),
        ('\u{1f9cd}', '\u{1f9ff}', 2, 2), ('\u{1fa70}', '\u{1fa74}', 2, 2), ('\u{1fa78}',
        '\u{1fa7a}', 2, 2), ('\u{1fa80}', '\u{1fa86}', 2, 2), ('\u{1fa90}', '\u{1faa8}', 2, 2),
        ('\u{1fab0}', '\u{1fab6}', 2, 2), ('\u{1fac0}', '\u{1fac2}', 2, 2), ('\u{1fad0}',
        '\u{1fad6}', 2, 2), ('\u{20000}', '\u{2fffd}', 2, 2), ('\u{30000}', '\u{3fffd}', 2, 2),
        ('\u{e0001}', '\u{e0001}', 0, 0), ('\u{e0020}', '\u{e007f}', 0, 0), ('\u{e0100}',
        '\u{e01ef}', 0, 0), ('\u{f0000}', '\u{ffffd}', 2, 2), ('\u{100000}', '\u{10fffd}', 2, 2)
    ];
